...
const MessageContainer = () => {
  ...
  const isUserAtBottom = () => {
    ...
    return scrollHeight - scrollTop <= clientHeight + 50; // Small margin
  };
  ...
  const checkImage = (filePath) => {
    const imageRegex = /\.(jpg|jpeg|png|gif|bmp|tiff|tif|webp|svg|heic|heif)$/i;
          ...
          >
            {checkImage(message.fileUrl) ? (
              ...
              <div className="flex items-center justify-center gap-4">
                <span className="text-white/80 text-3xl bg-black/30 rounded-full p-3">
                  <MdFolderZip />
                </span>
  ...
  const renderChannelMessage = (message) => {
    return (
      ...
      >
        ...
        {message.messageType === "file" &&
          console.log("Sent file URL:", message.fileUrl)}
        {message.messageType === "file" && (
          <div
            className={`${
              message.sender._id === userInfo.id
        ...
        {message.sender._id !== userInfo.id ? (
          <div className=" flex items-center justify-start gap-3">
            <Avatar className="w-8 h-8 rounded-full">
              ...
              <AvatarFallback
                className={`w-8 h-8 flex items-center justify-center text-lg font-bold rounded-full ${getColor(
